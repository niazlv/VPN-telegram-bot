        ...
        if call.data[:11] == "vpn_rendone":
            if call.data == "vpn_rendone":
                try:
                    ...
                    #done_btn = types.InlineKeyboardButton(text="Оплачено!")
...
def after_edit_vpn3(message):
    if(message.text.lower() == "продлить"):
        ...
        msg = bot.send_message(message.chat.id, "1 час")
